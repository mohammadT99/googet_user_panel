...
const Profile = () => {
    ...
    const handleimagedubmit =  async (e) => {
        ...
        if(image) {
            ...
            const {data} = await  Api.post('profile/avatar' , {avatar:e.target.files[0],type:'set'} ,{headers:{
...
//   use efect
    ...
    return (
        <>
            ...
            {/* Same as */}
            <ToastContainer/>
            {lodading ? <div className="Profile__content">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="profile__content__forms">
                        ...
                        <form className="form-control">
                            <div className="input">
                                <label className='label-input' htmlFor="input-name">نام</label>
                                <input
                                    id="input-name"
                                    type="text "
                        ...
                        <div className='avatar__box'>
                            <Avatar src={`http://192.168.1.129:9582${update.avatar}`} type="profile" size="150px"
                                    textsize='24' title={userData.name}/>
                            <div className="input__avatr">
                                    ...
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                             viewBox="0 0 50 50" fill="none">
                                                  ...
                                                  <path d="M31.9791 26.3545L24.9999 33.3337L18.0208 26.3545"
                                                        stroke="black" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round"/>
                                                </svg>
                                    </span>
                                ...
                                <input type="file" name="file" id={'avatar__input'} onChange={handleimagedubmit}/>
                            </div>
                        </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="profile__content__forms">
                        ...
                        <form className="form-control justify-start">
                            <div className="input ">
                                <label className='label-input' htmlFor="input-name">پست الکترونیکی *</label>
                                <input
                                    id="input-name"
                                    type="text "
                                ...
                                /></div>
                            <div className="input">
                                <label className='label-input' htmlFor="input-name">شماره تماس</label>
                                <input
                                    id="input-name"
                                    type="text "
                                    className="input-form email"
                    ...
                    <button type="button"
                            ...
                            className=" btn-profile text-darck hover:text-white   font-medium rounded-lg text-sm py-0.5   inline-flex items-center justify-center mx-auto ">
                        {
                            loadingbtn ?
                                ...
                                <span>
                    <svg aria-hidden="true" role="status" className="inline w-4 h-4 me-3 text-orange-50 animate-spin"
